    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            try
            {
                ...
                var pgsql = OpenDbConnection("Server=postgres;Username=" + Environment.GetEnvironmentVariable("POSTGRES_USER") + ";Password=" + Environment.GetEnvironmentVariable("POSTGRES_PASSWORD") + ";");
